    ...
    private var headerSection: some View {
        VStack(spacing: 10) {
            ...
            HStack {
                ...
                TextField("Search SNOMED CT concepts...", text: $viewModel.searchText)
                    .textFieldStyle(.plain)
                    .font(.system(size: 14))
                    .focused($isSearchFieldFocused)
                    .accessibilityIdentifier("search.searchField")
                    .accessibilityLabel("Search field")
                    .accessibilityHint("Type to search for SNOMED CT concepts")
    ...
    private var placeholderView: some View {
        VStack(spacing: 8) {
            Image(systemName: "text.magnifyingglass")
                .font(.system(size: 32))
                .foregroundColor(.secondary)
            Text("Type to search for SNOMED CT concepts")
                .foregroundColor(.secondary)
                .font(.callout)
        }
