...
final class SystemSelectionReader {
    ...
    private func getFocusedElementOnce() -> AXUIElement? {
        ...
        if elemResult == .success, let element = focusedElement {
            ...
            AXUIElementIsAttributeSettable(element as! AXUIElement, kAXSelectedTextRangeAttribute as CFString, &hasSelectionAttr)
        ...
        if AXUIElementCopyAttributeValue(element as! AXUIElement, kAXRoleAttribute as CFString, &sysRole) == .success {
